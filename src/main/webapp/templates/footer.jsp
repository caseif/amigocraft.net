			...
			<div id="footer">
				...
				<div id="planetminecraft">
					<a href="http://www.planetminecraft.com/server/amigocraft/"><img
							src="http://amigocraft.net/images/server_banner.png" alt="Amigocraft"
							title="Amigocraft on PlanetMinecraft"
							width=300></a>
				</div>
				<div id="crypto-addresses">
					...
					<br>
					Litecoin: <a
						href="litecoin:LKS6MF3cshtQe4CnwzrUt54UvW3qxmchv9">LKS6MF3cshtQe4CnwzrUt54UvW3qxmchv9</a>
					<br>
					Dogecoin: D6PKMaMYtWMHWwdWzENeor7xZSQkRFzZJu
					<br>
