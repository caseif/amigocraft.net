...
<ul>
	...
	<ul>
		...
		<li>Add customization page to <a href="/theme.php">themes page</a></li>
...
<ul>
	...
	<ul>
		...
		<li>Remove greentext in favor of Reddit-style quotes (seriously, what was I thinking with that?)</li>
	</ul>
</ul>
<ul>
